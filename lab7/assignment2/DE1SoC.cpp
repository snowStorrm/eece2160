 ...
 */
void DE1SOC::writeLED(int LEDIdx, bool state) { this->registerWrite(LEDR_BASE, setBitVal(this->registerRead(LEDR_BASE), LEDIdx, state)); }
/** Show the input integer value on LEDs
 *  - Calls RegisterWrite to set all LEDs 
 *  @param value	    Value to show on LEDs
 */
void DE1SOC::writeAllLEDs(int value) { this->registerWrite(LEDR_BASE, value); }
 ...
 */
bool DE1SOC::readSwitch(int swIdx) {
 ...
 */
int DE1SOC::readAllSwitches() { return this->registerRead(SW_BASE); }
